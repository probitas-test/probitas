...
describe("parseStack", () => {
  it("parses stack trace with function name and parentheses", () => {
    const stack = `Error
  ...
  it("parses stack trace without function name", () => {
    const stack = `Error
  ...
  it("parses stack trace without column number", () => {
    const stack = `Error
...
Random text`;
  ...
  describe("user frame detection", () => {
    it("marks ext: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks deno: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks node: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks npm: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks bun: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks cloudflare: frames as non-user", () => {
      const stack = `Error
    ...
    it("marks http:// frames as non-user", () => {
      const stack = `Error
    ...
    it("marks https:// frames as non-user", () => {
      const stack = `Error
    ...
    it("marks local file paths as user frames", () => {
      const stack = `Error
  ...
  describe("path normalization", () => {
    it("converts file:// URLs to local paths for user frames", () => {
      const stack = `Error
    ...
    it("preserves non-user frame paths without conversion", () => {
      const stack = `Error
...
describe("captureStack", () => {
  it("captures current call stack", () => {
  ...
  it("captures this test file as a frame", () => {
    const frames = captureStack();
  ...
  it("returns frames in correct order (innermost first)", () => {
