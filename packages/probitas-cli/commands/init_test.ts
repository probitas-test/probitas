  ...
  describe("when deno.json exists (no comments)", () => {
    ...
    it("does not overwrite existing probitas import", async () => {
      ...
      await Deno.writeTextFile(
        ...
        JSON.stringify(
          {
            imports: { "probitas": "jsr:@lambdalisue/probitas@^1.0.0" },
          },
          null,
          2,
        ),
      ...
      assertEquals(config.imports.probitas, "jsr:@lambdalisue/probitas@^1.0.0");
    });
    ...
    it("does not overwrite existing probitas section without --force", async () => {
      ...
      await Deno.writeTextFile(
        ...
        JSON.stringify(
          {
            imports: { "probitas": "jsr:@lambdalisue/probitas" },
